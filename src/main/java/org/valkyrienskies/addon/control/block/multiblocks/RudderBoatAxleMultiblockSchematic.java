...
public class RudderBoatAxleMultiblockSchematic implements IMultiblockSchematic {
    ...
    public RudderBoatAxleMultiblockSchematic() {
    ...
    public String getSchematicPrefix() {
        return "multiblock_rudder_boat_axle";
    }
    ...
    public void applyMultiblockCreation(World world, BlockPos tilePos, BlockPos relativePos) {
        ...
        if (!(tileEntity instanceof TileEntityRudderBoatPart)) {
            throw new IllegalStateException();
        }
        TileEntityRudderBoatPart enginePart = (TileEntityRudderBoatPart) tileEntity;
        enginePart.assembleMultiblock(this, relativePos);
    }

    @Override
    public List<IMultiblockSchematic> generateAllVariants() {
        Block rudderAxleBlock = ValkyrienSkiesControl.INSTANCE.vsControlBlocks.rudderBoatPart;
        // Order matters here
            ...
            for (EnumFacing possibleAxleAxisDirection : EnumFacing.VALUES) {
                for (EnumFacing possibleAxleFacingDirection : EnumFacing.VALUES) {
                    if (possibleAxleAxisDirection.getAxis() != possibleAxleFacingDirection
                        ...
                        RudderBoatAxleMultiblockSchematic schematicVariant = new RudderBoatAxleMultiblockSchematic();
