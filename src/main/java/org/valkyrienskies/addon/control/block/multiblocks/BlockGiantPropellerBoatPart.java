...
public class BlockGiantPropellerBoatPart extends BaseBlock implements ITileEntityProvider,
    IBlockForceProvider {

    public BlockGiantPropellerBoatPart() {
        super("giant_propeller_boat_part", Material.IRON, 0.0F, true);
    ...
    public void addInformation(ItemStack stack, @Nullable World player,
        ...
        itemInformation.add(TextFormatting.BLUE + I18n.format("tooltip.vs_control.giant_propeller_boat_part"));
