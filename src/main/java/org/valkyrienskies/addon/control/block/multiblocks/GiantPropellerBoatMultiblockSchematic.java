...
public class GiantPropellerBoatMultiblockSchematic implements IMultiblockSchematic {
    ...
    public GiantPropellerBoatMultiblockSchematic() {
    ...
    public void initializeMultiblockSchematic(String schematicID) {
        Block enginePart = ValkyrienSkiesControl.INSTANCE.vsControlBlocks.giantPropellerBoatPart;
    ...
    public String getSchematicPrefix() {
        return "multiblock_giant_propeller_boat";
    }
    ...
    public void applyMultiblockCreation(World world, BlockPos tilePos, BlockPos relativePos) {
        ...
        TileEntityGiantPropellerBoatPart enginePart = (TileEntityGiantPropellerBoatPart) tileEntity;
    ...
    public List<IMultiblockSchematic> generateAllVariants() {
        ...
        for (EnumFacing variantPropellerFacing : EnumFacing.values()) {
            for (int radius = 3; radius >= 1; radius--) {
                GiantPropellerBoatMultiblockSchematic variant = new GiantPropellerBoatMultiblockSchematic();
