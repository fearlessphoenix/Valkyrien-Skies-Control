...
public class BlockRudderBoatPart extends BaseBlock implements ITileEntityProvider, IBlockForceProvider {

    public BlockRudderBoatPart() {
        super("rudder_boat_part", Material.WOOD, 0.0F, true);
    ...
    public void addInformation(ItemStack stack, @Nullable World player,
        ...
        itemInformation.add(TextFormatting.BLUE + I18n.format("tooltip.vs_control.rudder_boat_part"));
