...
public class TileEntityGiantPropellerBoatPart extends
    TileEntityMultiblockPartForce<GiantPropellerBoatMultiblockSchematic, TileEntityGiantPropellerBoatPart> implements
    IRotationNodeProvider<TileEntityGiantPropellerBoatPart> {
    ...
    public TileEntityGiantPropellerBoatPart() {
        super();
    ...
    public boolean attemptToAssembleMultiblock(World worldIn, BlockPos pos, EnumFacing facing) {
        List<IMultiblockSchematic> schematics = MultiblockRegistry.getSchematicsWithPrefix("multiblock_giant_propeller_boat");
        for (IMultiblockSchematic schematic : schematics) {
            GiantPropellerBoatMultiblockSchematic propSchem = (GiantPropellerBoatMultiblockSchematic) schematic;
