...
public class GiantPropellerBoatPartTileEntityRenderer extends
    TileEntitySpecialRenderer<TileEntityGiantPropellerBoatPart> {

    @Override
    public void render(TileEntityGiantPropellerBoatPart tileentity, double x, double y, double z,
        float partialTick,
        ...
        if (!tileentity.isPartOfAssembledMultiblock()) {
            ...
            GibsAtomAnimationRegistry.getAnimation("giant_propeller_boat").renderAnimation(1, brightness);
