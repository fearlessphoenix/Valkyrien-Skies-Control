...
public class RudderBoatPartTileEntityRenderer extends
    TileEntitySpecialRenderer<TileEntityRudderBoatPart> {

    @Override
    public void render(TileEntityRudderBoatPart tileentity, double x, double y, double z,
        float partialTick,
